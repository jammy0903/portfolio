  ...
  return (
    <div style={{ minHeight: '100vh', paddingTop: '5rem', paddingBottom: '5rem', paddingLeft: '1rem', paddingRight: '1rem' }}>
      <div style={{ maxWidth: '56rem', margin: '0 auto' }}>
        ...
        {/* Links */}
        {(project.links.github || (project.links as Record<string, string>).notion) && (
          <div style={{ display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap' }}>
            ...
            {(project.links as Record<string, string>).notion && (
              <a href={(project.links as Record<string, string>).notion} target="_blank" rel="noopener noreferrer" style={{ ...buttonStyle, backgroundColor: '#000' }}>
        ...
        {/* Images */}
        {(project as Record<string, unknown>).images && (
          <div style={{ ...cardStyle }}>
            <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#334155', marginBottom: '1.5rem' }}>Screenshots</h2>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1.5rem' }}>
              {((project as Record<string, unknown>).images as Array<{ src: string; caption: string }>).map((img, idx) => (
